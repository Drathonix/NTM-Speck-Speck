...
import com.hbm.blocks.insulator.BlockAsbestos;
import com.hbm.blocks.insulator.BlockInsulator;
...
public class ModBlocks {
	...
	public static Block machine_heat_exchanger;
	...
	public static Block rbmk_smelter;
	...
	private static void initializeBlock() {
		...
		ore_oil = new BlockOre(Material.rock).setBlockName("ore_oil").setCreativeTab(MainRegistry.blockTab).setBlockUnbreakable().setResistance(50.0F).setBlockTextureName(RefStrings.MODID + ":ore_oil");
		...
		block_insulator = new BlockInsulator(Material.cloth, RefStrings.MODID + ":block_insulator_top",0.5F).setBlockName("block_insulator").setCreativeTab(MainRegistry.blockTab).setStepSound(Block.soundTypeCloth).setHardness(5.0F).setResistance(10.0F).setBlockTextureName(RefStrings.MODID + ":block_insulator_side");
		block_fiberglass = new BlockInsulator(Material.cloth, RefStrings.MODID + ":block_fiberglass_top",0.70F).setBlockName("block_fiberglass").setCreativeTab(MainRegistry.blockTab).setStepSound(Block.soundTypeCloth).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_fiberglass_side");
		block_asbestos = new BlockAsbestos(Material.cloth, true, 5, true,0.80F).setBlockName("block_asbestos").setCreativeTab(MainRegistry.blockTab).setStepSound(Block.soundTypeCloth).setHardness(5.0F).setResistance(15.0F).setBlockTextureName(RefStrings.MODID + ":block_asbestos");
		...
		rbmk_smelter = new RBMKSmelter().setBlockName("rbmk_smelter").setCreativeTab(MainRegistry.machineTab).setHardness(50.0F).setResistance(60.0F).setBlockTextureName(RefStrings.MODID + ":rbmk/rbmk_smelter");
		...
		machine_heat_exchanger = new MachineHeatExchanger(Material.iron).setBlockName("machine_heat_exchanger").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":heat_exchanger");
	...
	private static void registerBlock() {
		...
		GameRegistry.registerBlock(rbmk_smelter,rbmk_smelter.getUnlocalizedName());
		...
		GameRegistry.registerBlock(machine_heat_exchanger,machine_heat_exchanger.getUnlocalizedName());
