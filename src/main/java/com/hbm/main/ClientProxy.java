...
public class ClientProxy extends ServerProxy {
	...
	public void registerTileEntitySpecialRenderer() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityRBMKRodSmart.class, new RenderRBMKLid());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityRBMKSmelter.class, new RenderRBMKLid());
		//ITER
	...
	public void registerBlockRenderer() {
		...
		RenderingRegistry.registerBlockHandler(RenderBlockMultipass.instance);
